...
class WikiRennesTemplate extends BaseTemplate {
	...
	public function execute() {
		...
		<img src="<?php echo $this->text('stylepath') ?>/WikiRennes/resources/images/cl-footer.png" width="230" height="50" style="margin-left: 12px;" />
	...
	function searchBox() {
		...
		<div id="p-search" class="portlet" role="search">
			...
			<img src="<?php echo $this->text('stylepath') ?>/WikiRennes/resources/images/separator.png" width="168" height="1" style="margin: 10px 0 0;" />
		</div>
	<?php
	}
	...
	function cactions() {
		...
		<div id="p-cactions" class="portlet" role="navigation">
			...
			<div class="pBody">
				<ul>
				<li id="ong-left">
					<img src="<?php echo $this->text('stylepath') ?>/WikiRennes/resources/images/onglet-left.png" border="0" width="3" height="25" style="margin-right: -0.3em;" />
				</li><?php
				...
				<li id="ong-right">
					<img src="<?php echo $this->text('stylepath') ?>/WikiRennes/resources/images/onglet-right.png" border="0" width="6" height="25" />
				</li>
				</ul>
